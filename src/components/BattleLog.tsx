...
export default function BattleLog() {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            />
            <ProjectCard 
              title="Self Employed/Caregiving" 
            ...
            />
            <ProjectCard 
              title="EY Design Studio - UX Engineer" 
        ...
        />
            <ProjectCard 
              title="Verizon via Infovision - Junior Software Developer" 
        ...
        />
              <ProjectCard 
              title="General Assembly - Software Engineer Fellow " 
