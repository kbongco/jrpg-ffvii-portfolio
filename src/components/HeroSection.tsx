export default function HeroSection() {
  return (
          ...
          <div className="flex-1 space-y-2">
            <h1 className="font-rajdhani text-6xl md:text-8xl font-bold tracking-wider text-glow-teal text-[#f0f8ff] uppercase leading-none">
              Kathleen Bongco
            </h1>
            <p className="font-rajdhani text-2xl md:text-3xl text-[#94a3b8] tracking-widest uppercase pl-1">
              Software Engineer
            </p>
          </div>
